Shader "Unlit/RotateThingsShader"
{
    Properties
    {
        ...
        _sliderTest("SliderTest", Range(0,10)) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                v2f o;
                if(v.vertex.y> _sliderTest * 5) v.vertex.xyz = rotGeral(v.vertex.xyz, _slideyaw,_slidePitch,_slideRoll);
        ...
        Pass
        {
            ...
            {
                v2f o;
                if(v.vertex.y> _sliderTest * 5) v.vertex.xyz = rotGeral(v.vertex.xyz, _Time.w,_slidePitch,_slideRoll);
                v.vertex.x += _slide; // translacao cubo
                o.vertex = UnityObjectToClipPos(v.vertex/4); 
                o.uv = TRANSFORM_TEX(v.uv, _MainTex);
                return o;
            }
