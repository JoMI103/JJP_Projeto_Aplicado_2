...
/*
        for(int x = 0; x < gridArray.GetLength(0); x++)
            for (int z = 0; z < gridArray.GetLength(1); z++)
            {
                Debug.DrawLine(orientation * GetLocalPosition(x, z) + originPosition, orientation * GetLocalPosition(x, z + 1) + originPosition, Color.blue, 100f);
                Debug.DrawLine(orientation * GetLocalPosition(x, z) + originPosition, orientation * GetLocalPosition(x + 1, z) + originPosition, Color.blue, 100f);
